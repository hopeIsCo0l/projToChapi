  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-violet-400/10 to-indigo-600/10 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
        ...
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-gray-700/20 p-8 animate-fade-in">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
              Be the first to know when we launch something amazing! Get early access and exclusive updates.
            </p>
          </div>
